<x-layouts.app>
    ...
    <div class="space-y-6">
        ...
        <!-- Form -->
        <div class="rounded-xl border border-gray-200 bg-white p-8 shadow-sm" style="width: 40rem">
            <form action="{{ route('admin.doctors.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative rounded-xl border border-gray-200 bg-white transition-all duration-200 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-100 @error('polyclinic_id') border-red-300 ring-2 ring-red-100 @enderror">
                ...
                <div>
                    ...
                    <div class="relative rounded-xl border bg-white transition-all duration-200 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-100 @error('photo_url') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror">
                        <textarea name="photo_url"
                               ...
                               rows="3"
                               class="w-full border-0 bg-transparent px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-0 rounded-xl"
                               placeholder='Paste tag <img> dari imgbb, contoh: <img src="https://i.ibb.co.com/xxx/foto.jpg" alt="foto" border="0">'>{{ old('photo_url') }}</textarea>
                    </div>
