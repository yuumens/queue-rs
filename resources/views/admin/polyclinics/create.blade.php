<x-layouts.app>
    <x-slot:title>Tambah Poliklinik</x-slot:title>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-semibold text-gray-900">Tambah Poliklinik</h1>
        </div>

        <!-- Form -->
        <div class="mx-auto max-w-lg rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
            <form action="{{ route('admin.polyclinics.store') }}" method="POST" class="space-y-6">
                @csrf
